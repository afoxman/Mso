...
function(_liblet_set_platform_definitions TARGET)
  ...
  if (${MSO_LIBLET_PLATFORM} STREQUAL ANDROID)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_ANDROID)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_POSIX)
  elseif(${MSO_LIBLET_PLATFORM} STREQUAL IOS)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_APPLE)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_IOS)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_POSIX)
  elseif(${MSO_LIBLET_PLATFORM} STREQUAL LINUX)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_LINUX)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_POSIX)
  elseif(${MSO_LIBLET_PLATFORM} STREQUAL MAC)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_APPLE)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_MAC)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_POSIX)
  elseif(${MSO_LIBLET_PLATFORM} STREQUAL WIN32)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_WINDOWS)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_WIN32)
  elseif(${MSO_LIBLET_PLATFORM} STREQUAL WINRT)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_WINDOWS)
    target_compile_definitions(${TARGET} PUBLIC MS_TARGET_WINRT)
  else()
    message(FATAL_ERROR "Unknown MSO_LIBLET_PLATFORM: \"${MSO_LIBLET_PLATFORM}\"")
  endif()
  ...
  if (CMAKE_CXX_STANDARD EQUAL 17)
    target_compile_definitions(${TARGET} PUBLIC _SILENCE_ALL_CXX17_DEPRECATION_WARNINGS)
  endif()
